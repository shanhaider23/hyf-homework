...
function getReply(command) {
  ...
  if (inputValue[0] === "Add") {
    toDoList.push(inputValue.slice(1, inputValue.indexOf("to")).join(" "));
    return (
      inputValue.slice(1, inputValue.indexOf("to")).join(" ") +
      " added to my todo"
    );
  }
...
console.log(getReply("Add cooking dinner to my todo"));
