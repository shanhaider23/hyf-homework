...
const differentAnimals = ["Squirrel", "Tiger", "Chimpanzee","Lion", "Panda" , "Walrus"];
...
function getSpiritAnimalName() {
    ...
    let index = differentAnimals[Math.floor(Math.random() * differentAnimals.length)];
    if (userName === '')
        outputAnimal.innerHTML = "Enter a valid name"
    else
